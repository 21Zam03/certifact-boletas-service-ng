...
import com.certicom.certifact_boletas_service_ng.request.*;
...
public class PaymentVoucherDeserializer extends InputField<PaymentVoucherRequest>{

    private final AnticipoPaymentDeserializer anticipoPaymentDeserializer;
    private final AditionalFieldPaymentVoucherDeserializer aditionalFieldPaymentVoucherDeserializer;
    private final PaymentCuotasDeserializer paymentCuotasDeserializer;
    private final GuiaPaymentVoucherDeserializer guiaPaymentVoucherDeserializer;
    private final DetailsPaymentVoucherDeserializer detailsPaymentVoucherDeserializer;
    ...
    public PaymentVoucherRequest deserialize(JsonParser jsonParser, DeserializationContext context) throws IOException, JacksonException {
        ...
        List<DetailsPaymentVoucherRequest> items;
        List<AnticipoPaymentRequest> anticipoPaymentRequests;
        List<AditionalFieldPaymentVoucherRequest> camposAdicionales;
        List<PaymentCuotasRequest> cuotas;
        List<GuiaPaymentVoucherRequest> guiaPaymentVoucherRequests;

        PaymentVoucherRequest objectResult;
        DetailsPaymentVoucherRequest item;
        AnticipoPaymentRequest anticipoPaymentRequest;
        AditionalFieldPaymentVoucherRequest aditionalFieldPaymentVoucherRequest;
        PaymentCuotasRequest cuota;
        GuiaPaymentVoucherRequest guiaPaymentVoucherRequest;
        JsonNode campoTrama;
        JsonNode itemJson;
        ...
        */
        ...
        anticipoPaymentRequests = null;
        if (trama.get(anticiposLabel) != null) {

            anticipoPaymentRequests = new ArrayList<AnticipoPaymentRequest>();
            iteratorAnticipos = trama.get(anticiposLabel).elements();
            while (iteratorAnticipos.hasNext()) {

                anticipoJson = iteratorAnticipos.next();
                anticipoPaymentRequest = anticipoPaymentDeserializer.deserialize(anticipoJson.traverse(jsonParser.getCodec()), context);
                anticipoPaymentRequests.add(anticipoPaymentRequest);
            }
        }
        ...
        if (trama.get(camposAdicionalesLabel) != null) {
            ...
            camposAdicionales = new ArrayList<AditionalFieldPaymentVoucherRequest>();
            ...
            while (iteratorCamposAdicionales.hasNext()) {
                ...
                aditionalFieldPaymentVoucherRequest = aditionalFieldPaymentVoucherDeserializer.deserialize(campoAdicionalJson.traverse(jsonParser.getCodec()), context);
                camposAdicionales.add(aditionalFieldPaymentVoucherRequest);
            }
        }
        ...
        if (trama.get(cuotasLabel) != null) {
            ...
            cuotas = new ArrayList<PaymentCuotasRequest>();
            iteratorCuotas = trama.get(cuotasLabel).elements();
            while (iteratorCuotas.hasNext()) {

                cuotaJson = iteratorCuotas.next();
                cuota = paymentCuotasDeserializer.deserialize(cuotaJson.traverse(jsonParser.getCodec()), context);
                cuotas.add(cuota);
            }
        }

        guiaPaymentVoucherRequests = null;
        if (trama.get(guiasRelacionadasLabel) != null) {

            guiaPaymentVoucherRequests = new ArrayList<GuiaPaymentVoucherRequest>();
            ...
            while (iteratorGuiasRelacionadas.hasNext()) {
                ...
                guiaPaymentVoucherRequest = guiaPaymentVoucherDeserializer.deserialize(guiaRelacionadaJson.traverse(jsonParser.getCodec()), context);
                guiaPaymentVoucherRequests.add(guiaPaymentVoucherRequest);
            }
        }
        ...
        if (trama.get(itemsLabel) != null) {
            ...
            items = new ArrayList<DetailsPaymentVoucherRequest>();
            iteratorItems = trama.get(itemsLabel).elements();
            while (iteratorItems.hasNext()) {

                itemJson = iteratorItems.next();
                item = detailsPaymentVoucherDeserializer.deserialize(itemJson.traverse(jsonParser.getCodec()), context);
                items.add(item);
            }
        }
