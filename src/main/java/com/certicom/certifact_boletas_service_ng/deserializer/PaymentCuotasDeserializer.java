...
@Component
public class PaymentCuotasDeserializer extends InputField<PaymentCuotasRequest> {

    @Override
    public PaymentCuotasRequest deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
        PaymentCuotasRequest objectResult;
        JsonNode trama;
        JsonNode campoTrama;
        ...
        objectResult = new PaymentCuotasRequest();
