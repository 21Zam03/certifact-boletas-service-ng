...
@Component
public class AnticipoPaymentDeserializer extends InputField<AnticipoPaymentRequest> {

    @Override
    public AnticipoPaymentRequest deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
        AnticipoPaymentRequest objectResult;
        JsonNode trama;
        JsonNode campoTrama;
        ...
        objectResult = new AnticipoPaymentRequest();
