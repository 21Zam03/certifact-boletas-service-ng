...
@Component
public class DetailsPaymentVoucherDeserializer extends InputField<DetailsPaymentVoucherRequest>{

    @Override
    public DetailsPaymentVoucherRequest deserialize(JsonParser jsonParser, DeserializationContext deserializationContext) throws IOException, JacksonException {
        DetailsPaymentVoucherRequest objectResult;
        JsonNode trama;
        JsonNode campoTrama;
        ...
        campoTrama = trama.get(productoIdLabel);
        productId = campoTrama != null && !campoTrama.isNull() ? campoTrama.longValue() : null;
        ...
        campoTrama = trama.get(adicionalLabel);
        adicional = (campoTrama != null) ? campoTrama.textValue() : null;

        objectResult = new DetailsPaymentVoucherRequest();
        objectResult.setCodigoUnidadMedida(codigoUnidadMedida);
        objectResult.setCantidad(cantidad);
        objectResult.setProductoId(productId);
        ...
        objectResult.setAdicional(adicional);
        return objectResult;
    }
